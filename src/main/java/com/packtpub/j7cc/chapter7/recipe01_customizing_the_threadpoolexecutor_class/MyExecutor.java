...
public class MyExecutor extends ThreadPoolExecutor {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        System.out.println("runnable code = " + r.hashCode());
        Future<?> result = (Future<?>) r;
        System.out.println("result code = " + result.hashCode());
        try {
            System.out.printf("*********************************\n");
            ...
            Date startDate = startTimes.remove(String.valueOf(r.
                    hashCode()));
            if (startDate == null) {
                System.out.println("hohoho error in case of hashcode collisions");
            } else {
